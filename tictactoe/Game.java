...
//	 */
//	public Game(Client xClient, Client oClient) {
//		theBoard = new Board();
...
//		xClient.prompt("\nYou are the 'X' player! Please enter your name:\n");
//		String name = xClient.readLine();
//		while (name == null) {
//			xClient.prompt("\nYou are the 'X' player! Please enter your name:\n");
//			name = xClient.readLine();
//		}
//		xPlayer = new HumanPlayer(name, LETTER_X);
//		// xPlayer = create_player(name, LETTER_X, this.theBoard, xClient);
//
//		xClient.prompt("\nYou are the 'X' player! Please enter your name:\n");
//		String name = xClient.readLine();
//		while (name == null) {
...
//		}
//
//		BufferedReader xIn = new BufferedReader(InputStreamReader(xPlayerSocket));
...
//	// Client stdin) throws IOException {
//	// // // Get the player type.
